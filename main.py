...
if authentication_status:
    ...
    st.dataframe(df_main.drop(df_main[df_main.iloc[:,0] != df_main.iloc[-1,0]].index)[['신청일자','교육일자','과정명','소속부문','파트너','사원번호','성명','입사연차']].reset_index(), use_container_width=True) # 마지막 신청일자 제외한 나머지 신청내역 삭제
