...
if authentication_status:
    ...
    metrics_fa(st, "교육신청 TOP5 (소속부문)", df_stats, '신청누계', '수료율', 2)
    metrics_fa(st, "교육수료 TOP5 (소속부문)", df_stats, '수료누계', '수료율', 4)
    metrics_fa(st, "수료율 TOP5 (소속부문) (수료율 동률일 경우 수료누계 기준 순위정렬)", df_stats, '수료율', '수료누계', 5)
