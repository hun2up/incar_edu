...
def fig_hbarchart(list_hbarchart):
    ...
    if list_hbarchart[4] == 'group' :
        ...
        layout_groupbar = pl.graph_objs.Layout(title=list_hbarchart[9],yaxis={'categoryorder':'array', 'categoryarray':list_hbarchart[8]}, annotations=[dict(text=list_hbarchart[10],showarrow=False,xref='paper',yref='paper',x=-0.5,y=1.1)])
